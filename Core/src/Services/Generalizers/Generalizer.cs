...
public class Generalizer
{
    ...
    public IValueDictionary<string, Type> GetTypeArguments(Maybe<IDictionary<string, object?>> arguments)
    {
        ...
        {
            if (arguments.HasValue && arguments.Value.TryGetValue(typeParameter.ToLower(), out object? argument))
            {
