...
[Singleton<AssetCatalogOld>]
public interface IAssetCatalogOld : IAssetFolder
{
...
public class AssetCatalogOld : IAssetCatalogOld
{
    public AssetCatalogOld()
    {
        AutoUnload();
    }
    ...
    IAssetCatalogOld IAssetFolder.Assets => this;
